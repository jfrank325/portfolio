...
import Image from "../images/JFRound.png"
    ...
    <ScrollAnimation animateIn="opaque">
      <div className="about-container opaque">
        ...
        <div className="content">
          <h1>About Me</h1>
          <p>
            I'm a Front-end Developer with a passion for creating unique user
            experiences with clean and effective code in the newest
